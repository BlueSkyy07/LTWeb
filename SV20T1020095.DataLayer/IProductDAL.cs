...
namespace SV20T1020095.DataLayer
{
    public interface IProductDAL
    {
        ...
        /// <summary>
        /// Đém số lượng mặt hàng tìm kiếm được
        /// </summary>
        /// <param name="searchValue">Tên mặt hàng cần tìm (chuỗi rỗng nếu không tìm kiếm)</param>
        /// <param name="categoryId">Mã loại hàng cần tìm (0 nếu không tìm theo loại hàng)</param>
        /// <param name="supplierId">Mã nhà cung cấp cần tìm (0 nếu không tìm theo nhà cung cấp)</param>
        ...
        /// <summary>
        /// Bỏ sung mặt hàng mới (hàm trả về mã của mặt hàng được bổ sung)
        /// </summary>
        ...
        /// <summary>
        /// Lấy danh sách ảnh của một hàng (sắp xếp theo thứ tự của DisplayOrder)
        /// </summary>
        /// <param name="productId"></param>
        // / <returns></returns>
        ...
        /// </summary>
        /// <param name="photo10"></param>
        /// <returns></returns>
        ProductPhoto? GetPhoto(long photoId);

        /// <summary>
        /// Bổ sung 1 ảnh cho mặt hàng (hàm trà về mã của ảnh được bổ sung)
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Cập nhật thuộc tính của một hàng
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>

...
namespace SV20T1020095.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        /// <summary>
        /// Trang hiển thị danh sách các mặt hàng đang co trong giỏ hàng
        /// </summary>
        /// <returns></returns>
        ...
        public IActionResult AddToCart(OrderDetail data)
        {
            ...
            else //Nếu mặt hàng đã có trong giỏ hàng thì tăng số lượng và thay đổi giá bán
            {
        ...
        /// <summary>
        /// Khởi tạo đơn hàng (lập 1 đơn hàng mới).
        ...
        /// <param name="deliverProvince"></param>
